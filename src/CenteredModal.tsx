...
const CenteredModal: React.FC<CenteredModalProps> = ({
  ...
  const handleAcceptInvitation = () => {
    ...
    mobileCore!.invitation
      .checkInvitationStatus(invitationParams)
      .andThen(status => {
        console.log(
          '---------------------------------------------------STATUS',
          EInvitationStatus[status]
        );
        return mobileCore!.invitation
          .acceptInvitation(
            invitationParams,
    ...
    >
      ...
      {status === 0 && (
        ...
        >
          ...
          >
            {isLoading && (
              <View style={{ position: 'absolute', height: 150, top: 310 }}>
            ...
            <View style={styles.container}>
              ...
              >
                <Image
                  ...
                  source={{
                    uri:
                      'https://webpackage.snickerdoodle.com/snickerdoodle.png',
                  }}
                />
